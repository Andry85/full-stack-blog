  ...
  return (
    <div className='flex flex-col xl:flex-row gap-8'>
      ...
      <div className='flex flex-col gap-4 xl:w-2/3'>
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut nostrum distinctio eveniet tempore repellat quis hic cupiditate, provident excepturi, doloribus quam, amet minus harum qui dolorem nemo? Tempore, voluptatum praesentium!</p>
